...
public class OutrosFuncionarios extends Funcionarios implements Beneficios {

	private double salarioLiquido;
	private double salarioBruto;
	private double bonificacao;
	private final double valorHora = 20;
	
	public OutrosFuncionarios(int codigo, String nome) {
		super(codigo, nome);
	}

	public void calcularLiquido(double horasTrab) { 
	...
	public void bonificacao(double horasTrab) {
		...
		if (horasTrab < 100) { 
			bonificacao = 0;
			System.out.println("O funcionário não atingiu as horas necessárias para receber bonificação (100h)!");
			return;
		}
		
		bonificacao = this.salarioLiquido * 0.3;
